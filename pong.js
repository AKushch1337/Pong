...
const updatePosition = () => {
    ...
    if (
        ballProperties.y - ballProperties.radius < 0 ||
        ballProperties.y + ballProperties.radius > gameHeight
    ) {
    ...
    let player =
        ballProperties.x + ballProperties.radius < gameWidth / 2
            ? player1Properties
            : player2Properties;
    ...
    if (checkCollision(ballProperties, player)) {
        ...
        let direction =
            ballProperties.x + ballProperties.radius < gameWidth / 2 ? 1 : -1;
        ballProperties.directionX =
            direction * ballProperties.speed * Math.cos(angleBounce);
...
const drawObjects = () => {
    ...
    //draw ball
    drawBall(
        ballProperties.color,
        ballProperties.borderColor,
        ballProperties.x,
        ballProperties.y,
    ...
    drawPaddle(
        ...
        player1Properties.borderColor,
        player1Properties.color
    );
    ...
    drawPaddle(
        ...
        player2Properties.borderColor,
        player2Properties.color
    );
};
onkeydown = (event) => {
